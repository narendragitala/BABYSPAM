...
Deadly_Button = [
        [
        Button.url("Cʜᴀɴɴᴇʟ", "https://t.me/BROKENSHAYRI1"),
        Button.url("Sᴜᴘᴘᴏʀᴛ", "https://t.me/SHAYRIGALIBKI")
        ],
        [
        Button.url("• Rᴇᴘᴏ •", "https://t.me/ALL_ABOUT_NARU")
        ]
        ]
...
async def start(e):
    if e.chat_id is e.sender_id:
        ...
        creator = f"[『𝗡𝗔𝗥𝗨』| ͢ 𝗝𝗔𝗔𝗧𓄂⃝🔱 𝗡 ❤️ 𝗡](tg://user?id={5473771943})"
        DEADLY_ON = f"""
ʜᴇʏ {mention},
